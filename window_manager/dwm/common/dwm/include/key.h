...
static const Key keys[] = {
  ...
  // +-------------------------------------------------+
	...
	{ 0,                                XK_c,                             movecenter,                       {},                                           1},
	{ MODKEY|ShiftMask,                 XK_j,                             movestack,                        {.i = +1 },                                   0},
	{ MODKEY|ShiftMask,                 XK_k,                             movestack,                        {.i = -1 },                                   0},
  ...
  // Window movement and swap
	...
	// { MODKEY|ShiftMask,                 XK_x,                             spawn,                            SHCMD("sc_prompt 'Do you want to shutdown?' 'shutdown -h now'"),               0},
	// { MODKEY|ShiftMask,                 XK_r,                             spawn,                            SHCMD("sc_prompt 'Do you want to reboot?' 'reboot'"),                          0},
	{ MODKEY|ShiftMask,                 XK_e,                             spawn,                            SHCMD("sc_prompt 'Do you want to exit dwm?' 'pkill dwm'"),                        0},
	{ MODKEY|ShiftMask,                 XK_l,                             spawn,                            SHCMD("slock"),                                                                   0},
	{ MODKEY|ControlMask|ShiftMask,     XK_l,                             spawn,                            SHCMD("sc_prompt 'Do you want to suspend?' 'slock systemctl suspend -i'"),        0},
