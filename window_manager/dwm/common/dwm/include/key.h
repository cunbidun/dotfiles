...
static const Key keys[] = {
 ...
 // +------+
  ...
  // {MODKEY | ALTKEY,                  XK_6,                    incrihgaps,           {.i = +1},  4 },     {MODKEY | ALTKEY | ShiftMask,      XK_6,
  // incrihgaps,
  // {.i = -1},                                                                 4 },     {MODKEY | ALTKEY,                  XK_7,  incrivgaps,
  // {.i = +1},                                                                 4 },     {MODKEY | ALTKEY | ShiftMask,      XK_7,  incrivgaps,
  // {.i = -1},                                                                 4 },     {MODKEY | ALTKEY,                  XK_8,  incrohgaps,
  // {.i = +1},                                                                 4 },     {MODKEY | ALTKEY | ShiftMask,      XK_8,  incrohgaps,
  // {.i = -1},                                                                 4 },     {MODKEY | ALTKEY,                  XK_9,  incrovgaps,
  // {.i = +1},                                                                 4 },     {MODKEY | ALTKEY | ShiftMask,      XK_9,  incrovgaps,
  // {.i = -1},                                                                 4 },
 ...
 // +----------+
  // | Tag Keys |
  // +----------+
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_w, 4) TAGKEYS(XK_v, 5) TAGKEYS(XK_a, 6) TAGKEYS(XK_8, 7) TAGKEYS(XK_9, 8)
};
