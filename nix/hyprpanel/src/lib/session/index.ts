...
const defaultConfigDir = `${GLib.get_user_config_dir()}/ags/hyprpanel/config`;
const resolvedConfigDir = GLib.getenv('HYPRPANEL_CONFIG_DIR') ?? defaultConfigDir;

Object.assign(globalThis, {
    CONFIG_DIR: resolvedConfigDir,
    CONFIG_FILE: `${resolvedConfigDir}/config.json`,
