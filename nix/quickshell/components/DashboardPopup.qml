...
Rectangle {
    ...
    function runQuickAction(action) {
        if (action === "record") {
            runCommand(`${Quickshell.env("HOME")}/dotfiles/nix/hyprpanel/scripts/screen_record.sh ${root.recording ? "stop" : "start region \"$HOME/Videos\""}`);
