...
Item {
    ...
    function resolveThemeName(name) {
        ...
        if (["default-dark", "default-light", "catppuccin-dark", "catppuccin-light", "everforest-dark", "everforest-light", "gruvbox-dark", "gruvbox-light", "rose-pine-dark", "rose-pine-light"].includes(normalized)) {
            return normalized;
        }
