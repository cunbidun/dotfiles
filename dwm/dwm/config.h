...
/* tagging */
static const char *tags[] = {"sys", "dev", "web",  "4", "5",
                             "6",   "7",   "chat", "vi"};
...
static const Rule rules[] = {
     ...
     */
    /* class              role          instance         title            tags
       mask     isfloating    isterminal      noswallow       monitor */
    // { "firefox",          NULL,         "Navigator",     NULL,            0,
    // 1,            0,              0,              -1 },
    ...
    // { "Google-chrome",    NULL,         "google-chrome", NULL,            1
    // << 2,       0,            0,              0,              -1 }, // tag 3
    // { "Google-chrome",    NULL,         NULL,            "chat - reddit", 1
    // << 7,       0,            0,              0,              -1 }, // tag 3
};
...
static const char *dmenucmd[] = {
    ...
    "-nf",       col_gray3, "-sb",    nord9, "-sf",     col_gray4, NULL};
static const char *termcmd[] = {TERMINAL, NULL};
#include "movestack.c"
static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = {TERMINAL,
                                      "-t",
                                      scratchpadname,
                                      "-o",
                                      "window.dimensions.columns=160",
                                      "-o",
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_x, spawn,
     SHCMD("sc_prompt 'Do you want to shutdown?' 'shutdown -h now'")},
    {MODKEY | ShiftMask, XK_r, spawn,
     SHCMD("sc_prompt 'Do you want to reboot?' 'reboot'")},
    {MODKEY | ShiftMask, XK_e, spawn,
     SHCMD("sc_prompt 'Do you want to exit dwm?' 'pkill dwm'")},
...
static Button buttons[] = {
    ...
    {ClkStatusText, 0, Button2, spawn,
     SHCMD(TERMINAL " -e nvim ~/dwmblocks-async/config.h")},
